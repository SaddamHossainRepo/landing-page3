...
const ServiceType = () => {
    return (
        <div className="bg-black text-white text-start pl-32 pt-36">
            ...
            <h4 className="rota-bold mb-8 bg-gradient-to-r from-teal-500 via-cyan-400 to-green-800 text-transparent bg-clip-text text-4xl font-bold">Develop, Exhibit, Secure</h4>
